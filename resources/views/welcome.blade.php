        ...
        <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
            <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                <div class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-es-lg rounded-ee-lg lg:rounded-ss-lg lg:rounded-ee-none">
                    <h1 class="mb-1 font-medium text-2xl">Welcome to the Gas Station Management System</h1>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Streamline your fuel station operations with our comprehensive management platform. <br>Get started with the following features.</p>
                    <ul class="flex flex-col mb-4 lg:mb-6">
                        <li class="flex items-center gap-4 py-2 relative before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:top-1/2 before:bottom-0 before:left-[0.4rem] before:absolute">
                            ...
                            <span>
                                Manage fuel inventory and
                                <a href="/inventory" class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-[#2563eb] dark:text-[#4da6ff] ms-1">
                        ...
                        <li class="flex items-center gap-4 py-2 relative before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:bottom-1/2 before:top-0 before:start-[0.4rem] before:absolute">
                            ...
                            <span>
                                Monitor pump operations and
                                <a href="/pumps" class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-[#2563eb] dark:text-[#4da6ff] ms-1">
            ...
            @endif
                ...
                <div class="bg-[#f0f8ff] dark:bg-[#001122] relative lg:-ms-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-e-lg! aspect-[335/376] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden flex items-center justify-center">
                    <!-- Gas Station Icon -->
                    <div class="transition-all translate-y-0 opacity-100 duration-750 starting:opacity-0 starting:translate-y-6 flex flex-col items-center">
                        <!-- Fuel Pump Icon -->
                        <svg class="w-32 h-32 text-[#2563eb] dark:text-[#4da6ff] mb-4" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <!-- Pump Base -->
                            <rect x="20" y="70" width="40" height="25" rx="3" fill="currentColor"/>
                            <!-- Pump Body -->
                            <rect x="25" y="25" width="30" height="50" rx="4" fill="currentColor"/>
                            <!-- Display Screen -->
                            <rect x="30" y="35" width="20" height="15" rx="2" fill="white" stroke="currentColor" stroke-width="1"/>
                            <!-- Fuel Hose -->
                            <path d="M55 45 Q70 40 75 50 Q80 60 75 70" stroke="currentColor" stroke-width="3" fill="none" stroke-linecap="round"/>
                            <!-- Nozzle -->
                            <ellipse cx="75" cy="70" rx="4" ry="8" fill="currentColor"/>
                            <!-- Fuel Drop -->
                            <circle cx="75" cy="82" r="2" fill="currentColor"/>
                            <!-- Buttons -->
                            <rect x="27" y="55" width="6" height="4" rx="1" fill="white"/>
                            <rect x="35" y="55" width="6" height="4" rx="1" fill="white"/>
                            <rect x="43" y="55" width="6" height="4" rx="1" fill="white"/>
                        </svg>
                        
                        <!-- System Title -->
                        <h2 class="text-3xl font-semibold text-[#2563eb] dark:text-[#4da6ff] text-center">
                            Gas Station
                        </h2>
                        <h3 class="text-xl font-medium text-[#1b1b18] dark:text-[#EDEDEC] text-center mt-1">
                            Management System
                        </h3>
                        ...
                        <div class="flex gap-6 mt-8">
                            ...
                            <div class="flex flex-col items-center">
                                <svg class="w-8 h-8 text-[#2563eb] dark:text-[#4da6ff]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="3" y="3" width="18" height="18" rx="2" stroke="currentColor" stroke-width="2" fill="none"/>
                                    <path d="M9 9h6v6H9z" fill="currentColor"/>
                                    <path d="M7 7h2v2H7zM15 7h2v2h-2zM7 15h2v2H7zM15 15h2v2h-2z" fill="currentColor"/>
                                </svg>
                                <span class="text-xs mt-1 text-[#706f6c] dark:text-[#A1A09A]">Inventory</span>
                            </div>
                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <span class="text-xs mt-1 text-[#706f6c] dark:text-[#A1A09A]">Sales</span>
                            </div>
                            ...
                            <div class="flex flex-col items-center">
                                <svg class="w-8 h-8 text-[#2563eb] dark:text-[#4da6ff]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M7 16l4-4 4 4 5-5" stroke="currentColor" stroke-width="2" fill="none"/>
                                </svg>
                                <span class="text-xs mt-1 text-[#706f6c] dark:text-[#A1A09A]">Reports</span>
                            </div>
                        </div>
                    </div>
...
<footer class="w-full max-w-[335px] lg:max-w-4xl text-center py-4 mt-auto">
    <div class="text-xs text-zinc-500 dark:text-zinc-400">
        <span>Developed by </span>
        <a href="https://lkprofessionals.com" 
           target="_blank" 
           rel="noopener noreferrer" 
           class="font-medium hover:text-[#2563eb] dark:hover:text-[#4da6ff] transition-all">
