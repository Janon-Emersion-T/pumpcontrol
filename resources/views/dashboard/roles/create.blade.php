<x-layouts.app :title="__('Create Role')">
    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl bg-white dark:bg-gray-900 p-6 shadow-lg">
        <div>
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Create New Role</h2>
            <p class="text-sm text-gray-600 dark:text-gray-300">Define a role and assign the appropriate permissions.</p>
        </div>
