        ...
        <form action="{{ route('fuel.meter-readings.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="pump_id" id="pump_id" required
                        ...
                        @foreach($pumps as $pump)
                            <option value="{{ $pump->id }}" data-fuel-id="{{ $pump->fuel_id }}" {{ old('pump_id') == $pump->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <input type="number" step="0.001" name="opening_reading" id="opening_reading" value="{{ old('opening_reading') }}" required
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.001" name="closing_reading" id="closing_reading" value="{{ old('closing_reading') }}" required
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="price_per_liter" id="price_per_liter" value="{{ old('price_per_liter') }}" required
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="reading_date" id="reading_date" value="{{ old('reading_date', date('Y-m-d')) }}" required
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                </div>
                ...
                <div>
                    ...
                    <input type="time" name="reading_time" id="reading_time" value="{{ old('reading_time', date('H:i')) }}" required
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <p id="total_dispensed" class="text-lg font-semibold text-blue-600 dark:text-blue-400">0.000 L</p>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Total Amount</label>
                        <p id="total_amount" class="text-lg font-semibold text-green-600 dark:text-green-400">Rs.0.00</p>
                    </div>
                </div>
            </div>
