<x-layouts.app :title="__('Add Fuel Purchase')">
    <div class="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6 max-w-3xl mx-auto space-y-6">
        ...
        <div class="flex justify-between items-center border-b pb-4">
            <h1 class="text-2xl font-semibold text-gray-800 dark:text-white">Add Fuel Purchase</h1>
        ...
        <form action="{{ route('fuel-purchases.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <select name="pump_id" id="pump_id" onchange="fetchFuel()" required
            ...
            <!-- Fuel Name -->
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Fuel Type</label>
                <input type="text" id="fuel_name" class="w-full bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-md text-gray-700 dark:text-white shadow-sm" readonly>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" step="0.01" name="liters" value="{{ old('liters') }}" required
                           class="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-800 dark:text-white shadow-sm focus:ring-green-500 focus:border-green-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Price Per Liter</label>
                    <input type="number" step="0.01" name="price_per_liter" value="{{ old('price_per_liter') }}" required
                           class="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-800 dark:text-white shadow-sm focus:ring-green-500 focus:border-green-500">
                </div>
            </div>
            ...
            <div>
                ...
                <textarea name="notes" rows="3"
                          class="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-800 dark:text-white shadow-sm focus:ring-green-500 focus:border-green-500">{{ old('notes') }}</textarea>
            </div>
